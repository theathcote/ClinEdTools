...
function balKey(){
    ...
    if (key == "MAcY") {pH = getRndInteger(7350,7380), pCo2 = getRndInteger(2700,4700)*7.5, biCarb = getRndInteger(16000,21000);}
    else if (key == "MAcN") {pH = getRndInteger(7080,7300), pCo2 = getRndInteger(4700,6000)*7.5, biCarb = getRndInteger(16000,21000);}
    else if (key == "MAcP") {pH = getRndInteger(7300,7349), pCo2 = getRndInteger(3200,4700)*7.5, biCarb = getRndInteger(16000,21000);}
    else if (key == "MAlY") {pH = getRndInteger(7420,7450), pCo2 = getRndInteger(5500,8000)*7.5, biCarb = getRndInteger(26500,30000);}
    else if (key == "MAlN") {pH = getRndInteger(7500,7650), pCo2 = getRndInteger(4700,6000)*7.5, biCarb = getRndInteger(26500,30000);}
    else if (key == "MAlP") {pH = getRndInteger (7451,7500), pCo2 = getRndInteger(5500,7000)*7.5, biCarb = getRndInteger(26500,30000);}
    else if (key == "RAcY") {pH = getRndInteger(7350,7380), pCo2 = getRndInteger(6100,8500)*7.5, biCarb = getRndInteger(24500,30000);}
    else if (key == "RAcN") {pH = getRndInteger(7080,7300), pCo2 = getRndInteger(6100,8500)*7.5, biCarb = getRndInteger(22000,26000);}
    else if (key == "RAcP") {pH = getRndInteger(7300,7349), pCo2 = getRndInteger(6100,8500)*7.5, biCarb = getRndInteger(24500,28000);}
    else if (key == "RAlY") {pH = getRndInteger(7420,7450), pCo2 = getRndInteger(2200,4400)*7.5, biCarb = getRndInteger(15000,21500);}
    else if (key == "RAlN") {pH = getRndInteger(7500,7650), pCo2 = getRndInteger(2200,4400)*7.5, biCarb = getRndInteger(22000,26000);}
    else if (key == "RAlP") {pH = getRndInteger(7451,7500), pCo2 = getRndInteger(2200,4400)*7.5, biCarb = getRndInteger(18000,21500);}          
    
    

    document.getElementById("pH").innerHTML = pH.toFixed(3);
    document.getElementById("pCo2").innerHTML = pCo2.toFixed(1);
...
function o2Res() {            
    ...
    if (hypoxicName == "no") {o2Res = getRndInteger(10500,13500)*7.5;}
    else if (hypoxicName == "moderate") {o2Res = getRndInteger(8500,10499)*7.5;}
    else if  (hypoxicName == "severe") {o2Res = getRndInteger(5500,8499)*7.5;}
...
function gluRes() {            
    ...
    if (glucoseName == "normal") {gluRes = getRndInteger(4000,7900);}
    ...
    else if (glucoseName == "moderate high") {gluRes = getRndInteger(7901,14000);}
    else if (glucoseName == "severe high") {gluRes = getRndInteger(14000,22000);}          
